...
### What exists
[esp/program/modules/tests/studentregtwophase.py](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/tests/studentregtwophase.py) — **573 lines**, **29 test methods** across one class ([StudentRegTwoPhaseTest](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/tests/studentregtwophase.py#17-573)).
...
| [view_classes](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/handlers/studentregtwophase.py#197-235) (page loads) | ✅ | [test_view_classes_page_loads](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/tests/studentregtwophase.py#488-493) |
| [view_classes](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/handlers/studentregtwophase.py#197-235) (categories shown) | ✅ | [test_view_classes_shows_categories](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/tests/studentregtwophase.py#494-501) |
| **[save_priorities](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/handlers/studentregtwophase.py#361-444) (success path)** | ❌ | Only error-path tests; the `StudentRegistration` creation path is untested |
| **[send_confirmation_email](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/handlers/studentregtwophase.py#538-557)** | ⚠️ | Only checked as side-effect in [test_confirm_success](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/tests/studentregtwophase.py#106-133), not isolated |
| **Unauthenticated access** | ❌ | No test for redirect to login |
...
### What exists
[esp/program/modules/tests/schedulingcheckmodule.py](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/tests/schedulingcheckmodule.py) — **198 lines**, **5 test methods**. All 5 test only [moderator_movement_dependency_loops](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/program/modules/handlers/schedulingcheckmodule.py#795-857).
...
**[esp/db/views.py](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/db/views.py), line 18** (this is the [autocomplete_wrapper](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/db/views.py#14-22) function, before the [ajax_autocomplete](file:///home/dewolf/OpenSource/esp/devsite/esp/esp/db/views.py#23-69) view begins at line 24):**
```python
...
### ⚠️ Unverified: Open PRs
The notes previously referenced PR #5087 and PR #4903 — **these PR numbers could not be verified from the local codebase**. Check the GitHub PR list at [github.com/learning-unlimited/ESP-Website/pulls](https://github.com/learning-unlimited/ESP-Website/pulls) before citing them in your proposal.
...
- A browser runner [SpecRunner.html](file:///home/dewolf/OpenSource/esp/devsite/esp/public/media/scripts/jasmine/SpecRunner.html) exists at [esp/public/media/scripts/jasmine/SpecRunner.html](file:///home/dewolf/OpenSource/esp/devsite/esp/public/media/scripts/jasmine/SpecRunner.html) — but it only includes [DirectorySpec.js](file:///home/dewolf/OpenSource/esp/devsite/esp/public/media/scripts/ajaxschedulingmodule/spec/DirectorySpec.js), not all 16 spec files. The other 15 specs have **no runner at all**.
...
### ⚠️ Unverified: Open PRs
A PR migrating the scheduler to Jest may exist — verify on GitHub. If active, reference it and build upon it. If no PR exists, this is purely greenfield work and a strong proposal opportunity.
